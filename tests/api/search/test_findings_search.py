...
def test_pagination_page_zero_is_well_defined(
    ...
    # Documented as 1-based: page=0 must be well-defined (4xx) or at least a
    # consistent, non-crashing response — never a 500.
...
def test_status_filter_is_case_insensitive(
    ...
    client = findings_client_for(admin_alpha)  # org_alpha_finding guarantees an "open" one
